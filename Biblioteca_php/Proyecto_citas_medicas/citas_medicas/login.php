...
if(isset($_POST['login'])) {
    ...
    if($errMsg == '') {
      try {
$stmt = $connect->prepare('SELECT id, nombre, usuario, email,clave, cargo FROM usuarios
 WHERE usuario = :usuario UNION SELECT codpaci, nombrep,apellidop, usuario, clave, cargo
 FROM customers WHERE usuario = :usuario');
...
<body>
    ...
    <div class="img">
    <img src="assets/img/institucion.jpg" alt="">
    </div>
    <div class="contenido-login">

    <form autocomplete="off" method="POST"  role="form">

    <img src="assets/img/logo_avatar.png" alt="">
    <h2>Login</h2>
    <?php
    if(isset($errMsg)){
